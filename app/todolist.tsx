...
// เพิ่ม storeData เข้ามาใน import
...
export default function TodoList() {
  ...
  const onLoad = async () => {
    ...
    // SET STATE
    // ถ้ามีข้อมูล (data ไม่เป็น null) ให้อัปเดต state
    if (data) {
        setTodos(data);
    }
  };
  ...
  const onCreate = () => {
    ...
    // บันทึกข้อมูล array ใหม่ทั้งหมดลง storage
    storeData("todos", t);
  };
  ...
  const onCheck = (id: string) => {
    ...
    // WRITE ITEM TO STORAGE yoyoyoyoyo
    storeData("todos", t);
  };
  ...
  const onDelete = (id: string) => {
    ...
    // เนื่องจากเราลบออกจากตัวแปร t แล้ว เราก็แค่บันทึก t ที่เหลือทับลงไป
    storeData("todos", t);
  };
